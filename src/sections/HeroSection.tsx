...
export default function HeroSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative min-h-screen w-full bg-[#D8D8D0] overflow-hidden pt-20"
    >
      {/* Background Pattern */}
      <div className="absolute inset-0 opacity-[0.04]">
        <svg className="w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
          <pattern id="grid" width="10" height="10" patternUnits="userSpaceOnUse">
            <path d="M 10 0 L 0 0 0 10" fill="none" stroke="#1D2F42" strokeWidth="0.5"/>
          </pattern>
      ...
      <div className="relative w-full px-4 sm:px-6 lg:px-8 xl:px-12 py-12 lg:py-20">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-[calc(100vh-160px)]">
          ...
          <div className="order-2 lg:order-1 z-10">
            <h1
              ref={headlineRef}
              className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-black text-[#1D2F42] leading-[0.95] tracking-tight mb-6"
            >
            ...
            <p
              ref={subheadRef}
              className="text-lg sm:text-xl text-[#3d5266] max-w-xl mb-8 leading-relaxed"
            >
            ...
            <div ref={ctaRef} className="flex flex-wrap gap-4">
              ...
              <Link
                to="/shop"
                className="inline-flex items-center gap-2 px-8 py-4 bg-[#1D2F42] text-white rounded-xl font-semibold text-sm uppercase tracking-wide hover:bg-[#0f1a25] hover:translate-y-[-2px] transition-all"
              >
            ...
            <div className="flex flex-wrap gap-8 mt-12 pt-8 border-t border-gray-200">
              <div>
                <p className="text-3xl font-black text-[#1D2F42]">12K+</p>
                <p className="text-sm text-[#3d5266]">Parcels Delivered</p>
              </div>
              <div>
                <p className="text-3xl font-black text-[#1D2F42]">99%</p>
                <p className="text-sm text-[#3d5266]">On-Time Rate</p>
              </div>
              <div>
                <p className="text-3xl font-black text-[#1D2F42]">24/7</p>
                <p className="text-sm text-[#3d5266]">Customer Support</p>
              </div>
            </div>
          </div>
          ...
          <div className="order-1 lg:order-2 relative">
            ...
            >
              ...
              <div className="absolute bottom-6 right-6 bg-white/95 backdrop-blur-sm p-4 rounded-2xl shadow-lg max-w-[200px]">
                <div className="flex items-center gap-3 mb-2">
                  <div className="w-10 h-10 bg-[#1D2F42]/10 rounded-full flex items-center justify-center">
                    <Package className="w-5 h-5 text-[#1D2F42]" />
                  </div>
                  <div>
                    <p className="text-sm font-semibold text-[#1D2F42]">Fast Delivery</p>
                    <p className="text-xs text-[#3d5266]">USA to Ghana</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="absolute -z-10 -top-8 -left-8 w-32 h-32 bg-[#1D2F42]/5 rounded-full blur-2xl" />
          </div>
        </div>
      </div>
    </section>
