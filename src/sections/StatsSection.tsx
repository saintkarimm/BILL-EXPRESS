...
const stats = [
  { icon: Package, value: 12000, suffix: '+', label: 'Parcels Delivered', color: 'bg-[#D7263D]' },
    ...
    >
      ...
      <div className="relative w-full px-4 sm:px-6 lg:px-8 xl:px-12">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          <span className="label-text text-[#D7263D] mb-4 block">Our Impact</span>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-20">
          {stats.map((stat, index) => (
            ...
            >
              ...
              <p className="text-4xl font-black text-[#111111] mb-2">
        ...
        <div className="text-center">
          <p className="label-text text-[#6F6F6F] mb-8">Trusted by Industry Leaders</p>
          <div className="flex flex-wrap justify-center items-center gap-8 lg:gap-16">
            {partners.map((partner, index) => (
              <div
                key={index}
                className="text-2xl font-bold text-[#111111]/20 hover:text-[#111111]/40 transition-colors cursor-default"
              >
                {partner}
              </div>
            ))}
